...
Dentro del juego, tras instalar/actualizar archivos, haz **un solo** `/reload` para cargar v2.2:
...
Después no requiere `/reload` al cambiar de paso, objetivo o zona. RXPNameFixer v2.2:
